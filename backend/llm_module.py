...
class LLMModule:
    ...
    def build_agent_response_prompt(self, available_profiles: Optional[List[str]] = None) -> str:
        ...
        return (
            ...
            "Expresa siempre la hora en formato de 12 horas, escrita de forma natural en palabras, por ejemplo 'siete y cincuenta de la mañana' o 'tres de la tarde'. "
            "Para horas exactas puedes decir 'siete de la mañana' o 'tres de la tarde'. "
            "Usa 'de la mañana' para horas antes de las 12 y 'de la tarde' para horas desde las 12 en adelante. "
    ...
    def build_schedule_chat_prompt(
        ...
        return (
            ...
            "- Horas en HH:MM (24h).\n"
            "- La regla anterior aplica solo a datos estructurados del draft (meeting.start, meeting.end, range.start, range.end).\n"
